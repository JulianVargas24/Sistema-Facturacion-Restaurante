...
aplicacion.geometry('1150x630+0+0')  # se uso 1020 al principio

# Evitar maximizar pantalla
aplicacion.wm_resizable(0, 0)
...
# Lista de productos
lista_comidas = ['pollo', 'cordero', 'salmon', 'merluza', 'kebab', 'pizza1', 'pizza2', 'cerdo']
...
# Etiquetas de costo postres y campos de entrada
